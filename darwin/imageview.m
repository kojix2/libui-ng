...
@interface uiprivLayoutNeutralImageView : NSImageView
@end

@implementation uiprivLayoutNeutralImageView
- (NSSize)intrinsicContentSize
{
    // The parent layout determines the view size; the image only affects drawing.
...
- (instancetype)initWithFrame:(NSRect)frame
{
    ...
    if (self) {
        _iv = [[uiprivLayoutNeutralImageView alloc] init];
...
void uiImageViewSetImage(uiImageView *v, const uiImage *image)
{
    ...
    NSImage *nsimg = uiprivImageNSImage(image);
