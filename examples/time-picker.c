...
static void updateLabel(uiDateTimePicker *picker, uiLabel *label)
{
	...
	strftime(text, sizeof text, "Time: %X", &timebuf);
	uiLabelSetText(label, text);
}

static void onTimeChanged(uiDateTimePicker *picker, void *data)
{
...
int main(void)
{
	...
	w = uiNewWindow("Time Picker", 320, 160, 0);
	...
	uiDateTimePickerOnChanged(picker, onTimeChanged, label);
